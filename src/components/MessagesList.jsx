...
export const MessagesList = () => {
  ...
  // Renamed function to reflect Spanish language
  const renderSpanish = (spanish) => (
        ...
        <div key={i}>
          <div className="flex">
            <div className="flex-grow">
              ...
              {renderSpanish(message.answer.spanish)}
            </div>
